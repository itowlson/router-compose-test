...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 19748] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa5\x99\x01\x01A\x02\
...
\x20wasi:http/incoming-handler@0.2.0\x05@\x04\x01\x1ccomponent:auth/example@0.1.\
