...
pub mod auth {
    ...
    pub type IncomingRequest = super::wasi::http0_2_0::types::IncomingRequest;
    pub type ResponseOutparam = super::wasi::http0_2_0::types::ResponseOutparam;
    #[allow(unused_unsafe, clippy::all)]
    pub fn handle(request: IncomingRequest, response_out: ResponseOutparam) {
        unsafe {
            #[cfg(target_arch = "wasm32")]
            #[link(wasm_import_module = "auth")]
            extern "C" {
                #[link_name = "handle"]
...
macro_rules! __export_router2_impl {
...
#[doc(inline)]
pub(crate) use __export_router2_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:router2:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6557] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x9f2\x01A\x02\x01A\x17\
...
ndle\x01\x06\x03\0\x04auth\x05\x0c\x01B\x08\x02\x03\x02\x01\x0a\x04\0\x10incomin\
g-request\x03\0\0\x02\x03\x02\x01\x0b\x04\0\x11response-outparam\x03\0\x02\x01i\x01\
\x01i\x03\x01@\x02\x07request\x04\x0cresponse-out\x05\x01\0\x04\0\x06handle\x01\x06\
\x03\0\x05greet\x05\x0d\x01B\x08\x02\x03\x02\x01\x0a\x04\0\x10incoming-request\x03\
\0\0\x02\x03\x02\x01\x0b\x04\0\x11response-outparam\x03\0\x02\x01i\x01\x01i\x03\x01\
@\x02\x07request\x04\x0cresponse-out\x05\x01\0\x04\0\x06handle\x01\x06\x04\x01\x20\
wasi:http/incoming-handler@0.2.0\x05\x0e\x04\x01\x1fcomponent:router2/router2@0.\
1.0\x04\0\x0b\x0d\x01\0\x07router2\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
